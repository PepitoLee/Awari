...
export const CreatorSection: React.FC = () => {
  ...
  return (
    <section className="relative py-32 overflow-hidden bg-wool-100">
      
      {/* Background Texture - Knitted Pattern */}
      <div className="absolute inset-0 opacity-[0.03] pointer-events-none"
           style={{ backgroundImage: `radial-gradient(#835b36 1px, transparent 1px)`, backgroundSize: '30px 30px' }} 
      />

      {/* Floating Elements Background */}
      <div className="absolute top-20 left-10 text-blush-300 opacity-20 animate-float">
         <Heart size={64} fill="currentColor" />
      </div>
      <div className="absolute bottom-20 right-10 text-wool-300 opacity-40 animate-wiggle">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <div className="bg-white p-6 pb-20 shadow-2xl transform transition-transform duration-500 hover:rotate-0 hover:scale-105 relative z-10">
               ...
               {/* "Tape" Effect */}
               <div className="absolute -top-6 left-1/2 -translate-x-1/2 w-32 h-12 bg-yellow-100/80 backdrop-blur-sm shadow-sm transform -rotate-2 z-20"></div>
            </div>
            ...
            <motion.div 
              ...
              className="absolute -right-8 top-1/2 bg-white p-4 rounded-full shadow-lg z-20 text-blush-400"
            >
              <Sparkles size={32} />
            </motion.div>
          </motion.div>
          ...
          >
            <div className="inline-block p-3 rounded-2xl bg-blush-300/10 text-blush-400 mb-6">
            ...
            <h2 className="font-display font-black text-5xl md:text-6xl text-wool-900 mb-8 leading-tight">
              Manos que tejen <br/>
              <span className="text-blush-400">sueños tangibles.</span>
            </h2>

            <div className="space-y-6 text-lg text-wool-700 font-medium leading-relaxed font-sans">
              <p>
                Hola, soy el alma detrás de <strong className="text-wool-900">Arawi</strong>. Lo que comenzó como un pasatiempo para calmar la mente, se transformó en un pequeño universo de personajes.
              </p>
              <p>
              ...
              <p className="border-l-4 border-blush-300 pl-6 italic text-wool-600">
                "Cada amigurumi no es solo lana y relleno; es una pequeña pieza de mi corazón esperando hacer sonreír a alguien."
              </p>
            </div>

            <div className="mt-10 flex items-center gap-4">
               <div className="h-px bg-wool-300 flex-1"></div>
               <span className="font-display font-bold text-2xl text-wool-500 signing-font transform -rotate-6">
